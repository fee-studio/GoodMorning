...
#define mIphoneStoryBoard   [UIStoryboard storyboardWithName:@"Main_iPhone" bundle:nil]
...
//----------设备系统相关---------
#define mIsIphone4   ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(640, 960), [[UIScreen mainScreen] currentMode].size) : NO)
