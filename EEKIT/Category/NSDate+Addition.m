...
+ (NSString *)dateWithTimeInterval:(NSString *)timeInterval andFormat:(NSString *)format {

    NSString *formatString = [[NSDate dateWithTimeIntervalSince1970:
            [timeInterval integerValue]]
            convertDateToStringWithFormat:format];

    return formatString;
}

+ (NSString *)dateDefaultFormatWithTimeInterval:(NSString *)timeInterval {

    NSString *formatString = [[NSDate dateWithTimeIntervalSince1970:[timeInterval integerValue]] convertDateToStringWithFormat:@"yyyy-MM-dd HH:mm"];
