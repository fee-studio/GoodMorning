...
//    [self.titleLabel setFont:[UIFont fontWithName:@"FontAwesome" size:self.titleLabel.font.pointSize]];
    [self.titleLabel setFont:[UIFont fontWithName:@"Helvetica" size:self.titleLabel.font.pointSize]];
...
-(void)defaultStyle{
    ...
    [self setTitleColor:[UIColor colorWithHexString:@"3c3c3c"] forState:UIControlStateHighlighted];
    self.backgroundColor = [UIColor whiteColor];
    self.layer.borderColor = [[UIColor colorWithHexString:@"b1aba8"] CGColor];
...
-(void)dobbyStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithHexString:@"ff6f13"];
//    self.layer.borderColor = [[UIColor colorWithHexString:@"eee"] CGColor];
    self.layer.borderColor = [[UIColor colorWithWhite:0.7f alpha:0.3f] CGColor];
    
//    [self setBackgroundImage:[self buttonImageFromColor:[UIColor clearColor]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"fc9d49"]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"cccccc"]] forState:UIControlStateDisabled];
}
