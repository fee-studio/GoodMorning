...
const static CGFloat kCustomIOS7AlertViewDefaultButtonSpacerWidth = 1;
...
#pragma mark - static factory method
...
#pragma mark - add buttons to view

// Helper function: add buttons to container
- (void)addButtonsToView:(UIView *)container {
    if (buttonTitles == NULL) {return;}

    CGFloat buttonWidth = (container.bounds.size.width - buttonSpacerWidth * ([buttonTitles count] - 1)) / [buttonTitles count];
    for (int i = 0; i < [buttonTitles count]; i++) {

        // There is a line between the buttons
        if (i > 0) {
            UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(i * (buttonWidth + buttonSpacerWidth) - buttonSpacerWidth, container.bounds.size.height - buttonHeight, buttonSpacerWidth, buttonHeight)];
            lineView.backgroundColor = [UIColor colorWithRed:198.0 / 255.0 green:198.0 / 255.0 blue:198.0 / 255.0 alpha:1.0f];
        ...
        [closeButton setFrame:CGRectMake(i * (buttonWidth + buttonSpacerWidth), container.bounds.size.height - buttonHeight, buttonWidth, buttonHeight)];
...
- (CGSize)countScreenSize {
    if (buttonTitles != NULL && [buttonTitles count] > 0) {
        ...
        buttonSpacerWidth = kCustomIOS7AlertViewDefaultButtonSpacerWidth;
    } else {
        buttonHeight = 0;
